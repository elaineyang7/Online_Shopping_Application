...
/***
 * 
 * This class is worked when user opened the system and ask for login or create an account
 */
public class LoginView extends View 
{
	...
	public LoginView() 
	{
		...
		newAccButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				getSystem().setView(new SignupView());
			}
		});
	...
	public void initialize()
	{
		loginButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				getSystem().login(username.getText(), new String(password.getPassword()));
			}
		});
	}
